...
// Lesson interface for course lessons list
...
export const studentApi = {
  ...
  addLessonComment: async (
    ...
    try {
      const response = await apiRequest(
        `/student/lessons/${lessonId}/comments`,
        {
          method: "POST",
  ...
  submitQuizAnswer: async (
    ...
    try {
      const response = await apiRequest(`/student/lessons/${lessonId}/quiz`, {
        method: "POST",
  ...
  // ===== Announcement Methods (for Exams) =====
  getExamAnnouncements: async (params?: {
    page?: number;
    limit?: number;
    type?: string;
  }): Promise<{
    ...
    try {
      ...
      queryParams.append("type", "EXAM"); // Filter only exam announcements
      
      const response = await apiRequest(`/announcements?${queryParams.toString()}`, {
        method: "GET",
      });
      return response;
    } catch (error) {
      console.error("Error fetching exam announcements:", error);
      return { success: false };
    }
  },

  getAnnouncementById: async (id: number): Promise<{
    success: boolean;
    data?: Announcement;
  }> => {
    try {
  ...
  markAnnouncementAsRead: async (id: number): Promise<{
    success: boolean;
  }> => {
    try {
      const response = await apiRequest(`/announcements/${id}/read`, {
        method: "POST",
      });
      return response;
    } catch (error) {
  ...
  getStudentFullDetails: async (
    ...
    try {
      const response = await apiRequest(`/students/${studentId}/full-details`, {
        method: "GET",
      });
      return response;
    } catch (error) {
  ...
  getStudentPerformance: async (
    ...
    try {
      const response = await apiRequest(`/students/${studentId}/performance`, {
        method: "GET",
      });
      return response;
    } catch (error) {
  ...
  getStudentAttendance: async (
    ...
    try {
      const response = await apiRequest(
        `/students/${studentId}/attendance?days=${days}`,
        {
          method: "GET",
        },
      );
  ...
  getStudentCoursesWithGrades: async (
    ...
    try {
      const response = await apiRequest(
        `/students/${studentId}/courses-with-grades`,
        {
          method: "GET",
        },
      );
  ...
  getStudentClass: async (
    ...
    try {
      const response = await apiRequest(`/students/${studentId}/class`, {
        method: "GET",
      });
      return response;
    } catch (error) {
  ...
  getStudentParent: async (
    ...
    try {
      const response = await apiRequest(`/students/${studentId}/parent`, {
        method: "GET",
      });
      return response;
    } catch (error) {
